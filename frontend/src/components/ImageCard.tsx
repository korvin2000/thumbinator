...
import { formatDate, getResolutionClass } from '../data/utils';
...
const ImageCard: React.FC<ImageCardProps> = ({ image, onOpenDetail }) => {
  ...
  return (
    <div className="thumbnail-card fade-in" onClick={onOpenDetail} role="button" tabIndex={0} onKeyDown={handleKeyDown}>
